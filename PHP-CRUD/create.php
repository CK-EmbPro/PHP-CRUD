...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do {
        ...
        {
            $errorMessage = "Hey! fill in all the fields";
            break;
        }
        ...
        if(!$result){
                $errorMessage = "Ohhhh! Invalid query: " .  $connection->error;
                break;
        }
        ...
        $successMessage = "Yess! added successfully!";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="/proper/index.php" role="button">Return home</a>
                </div>
