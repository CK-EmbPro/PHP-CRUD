...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    do  {
        ...
        if(!$result){
            $errorMessage = "Oh no! Invalid query: " .$connection->error;
            break;

        }
        $successMessage = "Wow! added a user successfully";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="" role="button">Return Back</a>
                </div>
